...
// Icons
import { Cross, Calendar, Users, Moon, Sun, User, LogOut, Mail, FileText, ArrowLeft, Grid, List, Plus, Edit, Trash2, BarChart3, Bird, Candle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#que-es-la-confesion" className="text-gray-700 dark:text-gray-300 hover:text-purple-600 transition-colors">¿Qué es la confesión?</a>
            ...
            <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all group min-h-[320px] flex flex-col"
                >
                  <div className={`w-14 h-14 rounded-full bg-gradient-to-r ${saint.color} flex items-center justify-center mx-auto mb-4 text-lg group-hover:scale-110 transition-transform shadow-lg`}>
                    {saint.icon}
                  </div>
